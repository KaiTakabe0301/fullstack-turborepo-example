  ...
  return (
    <div ref={ref} className='flex flex-col lg:flex-row gap-6 w-full'>
      ...
      <div className='flex-1 flex flex-col gap-4'>
        ...
        <pre className='bg-white/[.05] dark:bg-white/[.06] border border-white/[.145] rounded-lg p-4 text-sm font-mono text-foreground overflow-x-auto'>
          {queryString}
        </pre>
        <button
      ...
      <div className='flex-1 flex flex-col gap-4'>
        ...
        <pre className='bg-white/[.05] dark:bg-white/[.06] border border-white/[.145] rounded-lg p-4 text-sm font-mono text-foreground overflow-x-auto min-h-[200px]'>
          {response}
        </pre>
      </div>
    </div>
