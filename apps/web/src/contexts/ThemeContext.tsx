import { createContext, useState, useCallback, useMemo, useEffect, memo, type ReactNode } from 'react';
...
export const ThemeProvider = memo(({ initialTheme, children }: ThemeProviderProps) => {
